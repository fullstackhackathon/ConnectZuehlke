...
describe('SearchPipe', () => {
  ...
  it('search on first and lastName with empty string', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, 'firstName,lastName', '');
  ...
  it('search on first and lastName with matching first and matching lastname', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, 'firstName,lastName', 'MA');
  ...
  it('search on firstName with matching firstname', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, 'firstName', 'Ma');
  ...
  it('search on lastName with matching lastName', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, 'lastName', 'ma');
  ...
  it('search on first/lastName with not-matching term', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, 'firstName,lastName', 'xx');
  ...
  it('search on anything with not-matching term', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, '*', 'a');
  ...
  it('search on not existing key sould return empty', () => {
    const pipe = new SearchPipe();
    const filteredEmployees = pipe.transform(employees, 'notExisting', 'a');
